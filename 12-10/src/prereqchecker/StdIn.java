 ...
 *  Compilation:  javac prereqchecker.StdIn.java
 *  Execution:    java prereqchecker.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code prereqchecker.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code prereqchecker.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">prereqchecker.StdIn.java</a>
 ...
 *  <pre>
 *  while (!prereqchecker.StdIn.isEmpty()) {
 *      double value = prereqchecker.StdIn.readDouble();
 *      prereqchecker.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (prereqchecker.StdIn.hasNextChar()) {
 *      char c = prereqchecker.StdIn.readChar();
 *      prereqchecker.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (prereqchecker.StdIn.hasNextLine()) {
 *      String line = prereqchecker.StdIn.readLine();
 *      prereqchecker.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = prereqchecker.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code prereqchecker.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code prereqchecker.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code prereqchecker.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code prereqchecker.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code prereqchecker.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code prereqchecker.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code prereqchecker.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code prereqchecker.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code prereqchecker.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to prereqchecker.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to prereqchecker.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to prereqchecker.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to prereqchecker.StdIn
    
    
    // do this once when prereqchecker.StdIn is initialized
    static {
        resync();
    }

    /**
     * If prereqchecker.StdIn changes, use this to reinitialize the scanner.
     */
   ...
   /**
    ...
    public static void setFile(String filename) {
        try {
            // scanner.close(); // warning, this may close prereqchecker.StdIn the first time!
